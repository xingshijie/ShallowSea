...
* 如果你是硬破(sx core/lite)機並想轉用大氣層，一定要先刪除整合包根目錄的「exosphere.ini」並使用[90dns](https://gbatemp.net/threads/90dns-dns-server-for-blocking-all-nintendo-servers.516234/)😎
