...
# 如果你是硬破機並想轉用大氣層，一定要先刪除整合包根目錄的exosphere.ini並使用[90dns](https://gbatemp.net/threads/90dns-dns-server-for-blocking-all-nintendo-servers.516234/)😎(If your switch is modded by sx core/lite and want to use atmosphere, u MUST DELETE 「exosphere.ini」 which located at the root of the sd card and use [90dns](https://gbatemp.net/threads/90dns-dns-server-for-blocking-all-nintendo-servers.516234/))
